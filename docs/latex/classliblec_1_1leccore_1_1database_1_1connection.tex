...
bool \mbox{\hyperlink{classliblec_1_1leccore_1_1database_1_1connection_a0dbce4dbe4aa89297466be7e67552070}{execute\+\_\+query}} (const std\+::string \&sql, const std\+::vector$<$ std\+::any $>$ \&values, table \&results, std\+::string \&error)
...
{\footnotesize\ttfamily bool liblec\+::leccore\+::database\+::connection\+::execute\+\_\+query (\begin{DoxyParamCaption}\item[{const std\+::string \&}]{sql,  }\item[{const std\+::vector$<$ std\+::any $>$ \&}]{values,  }\item[{table \&}]{results,  }\item[{std\+::string \&}]{error }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em sql} & The query, e.\+g. \char`\"{}\+SELECT Name, Surname FROM Members WHERE Unique\+ID = ?;\char`\"{}\\
\hline
{\em values} & The values to bind to the \mbox{\hyperlink{}{sql}} statement, e.\+g. \{ \char`\"{}\+T432\+FJ\char`\"{} \}\\
\hline
